...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Styles>
  ...
  <Style ss:ID="StockBajo">
   <Interior ss:Color="#FEF3C7" ss:Pattern="Solid"/>
   <Font ss:Size="10" ss:Bold="1" ss:Color="#B45309"/>
   <Alignment ss:Horizontal="Center" ss:Vertical="Center"/>
   <Borders>
    <Border ss:Position="Bottom" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#DDDDDD"/>
    <Border ss:Position="Top" ss:LineStyle="Continuous" ss:Weight="1" ss:Color="#DDDDDD"/>
 ...
 <Worksheet ss:Name="Inventario">
  <Table>
   ...
   <!-- TÍTULO Y FECHA -->
   <Row ss:Height="20">
    <Cell ss:StyleID="Titulo" ss:MergeAcross="7"><Data ss:Type="String">Reporte de Inventario</Data></Cell>
   </Row>
   <Row ss:Height="16">
   ...
   <Row ss:Height="22">
    ...
    <Cell ss:StyleID="Encabezado"><Data ss:Type="String">Producto</Data></Cell>
    ...
    <Cell ss:StyleID="Encabezado"><Data ss:Type="String">Cant. Actual</Data></Cell>
    <Cell ss:StyleID="Encabezado"><Data ss:Type="String">Stock Mínimo</Data></Cell>
   </Row>
   ...
   <?php foreach ($datos as $i => $item):
        ...
        $cantActual = (int) $item['cantidad_actual'];
        $stockMin   = (int) $item['stock_minimo'];
        $estiloStock = ($cantActual <= $stockMin) ? 'StockBajo' : 'StockOK';
   ?>
   <Row ss:Height="18">
    <Cell ss:StyleID="<?php echo $estilo; ?>"><Data ss:Type="Number"><?php echo (int) $item['id_inventario']; ?></Data></Cell>
    ...
    <Cell ss:StyleID="<?php echo $estiloStock; ?>"><Data ss:Type="Number"><?php echo $cantActual; ?></Data></Cell>
    <Cell ss:StyleID="<?php echo $estilo; ?>"><Data ss:Type="Number"><?php echo $stockMin; ?></Data></Cell>
   </Row>
   <?php endforeach; ?>
