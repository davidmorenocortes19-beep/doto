...
import {
  ...
  ActivityIndicator, TouchableOpacity, ImageBackground } from 'react-native';
...
const s = StyleSheet.create({
  background: { flex: 1 },
  container: { flexGrow: 1, backgroundColor: 'rgba(9,8,13,0.75)', padding: 24, paddingBottom: 40 },
  ...
  gridLabel: { color: '#eee', fontWeight: 'bold', fontSize: 13 },
});