...
const ROL_LIGHT  = '#FFEDD5';
const ROL_ICONO  = '🏭';
const ROL_NOMBRE = 'Bodeguero';
const ROL_DESC   = 'Gestión de inventario y despachos';

const opciones = [
  { icon: '🏠', label: 'Inicio',     ruta: '/bodeguero/panel_bodeguero' },
  { icon: '👤', label: 'Perfil',     ruta: '/bodeguero/perfil_bodeguero' },
  { icon: '🚚', label: 'Inventario', ruta: '/bodeguero/inventario' },
];
        ...
        <View style={styles.header}>
          ...
          <View style={[styles.accesoBar, { backgroundColor: ROL_LIGHT, borderColor: ROL_COLOR }]}>
            <Text style={[styles.accesoTexto, { color: ROL_COLOR }]}>
              📦 Nivel de acceso: <Text style={{ fontWeight: '700' }}>Logística</Text>
            </Text>
          </View>
        </View>
