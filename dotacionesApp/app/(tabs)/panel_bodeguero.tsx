...
export default function PanelBodeguero() {
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Panel Bodeguero</Text>
      ...
      <View style={styles.grid}>
        ...
        <View style={styles.card}><Text style={styles.cardIcon}>🚚</Text><Text style={styles.cardText}>Despachos</Text></View>
        <View style={styles.card}><Text style={styles.cardIcon}>🔍</Text><Text style={styles.cardText}>Búsqueda</Text></View>
        <View style={styles.card}><Text style={styles.cardIcon}>📋</Text><Text style={styles.cardText}>Entradas</Text></View>
      </View>
