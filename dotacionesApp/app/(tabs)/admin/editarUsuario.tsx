...
const BASE = 'http://172.30.3.242/dota/api';
...
export default function EditarUsuarioScreen() {
  ...
  const guardar = async () => {
    if (!nombre || !documento || !correo || !telefono || !direccion || !idRol) {
      Alert.alert('Campos incompletos', 'Por favor completa todos los campos');
      return;
    }
    try {
      setGuardando(true);
      const res = await axios.put(`${BASE}/editarAdmin.php`, {
    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.form}>
        ...
        <TextInput style={styles.input} value={documento} onChangeText={setDocumento}
          placeholderTextColor="#999" placeholder="Número de documento" keyboardType="numeric" />
