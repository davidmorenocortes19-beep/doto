...
const styles = StyleSheet.create({
  ...
  card:              { backgroundColor: '#F8F9FA', borderWidth: 1, borderColor: '#333333', borderRadius: 12, padding: 14, marginBottom: 14 },
  ...
  estadoPorPagar:    { backgroundColor: '#B7975B22', borderWidth: 1, borderColor: '#333333' },
  estadoPagado:      { backgroundColor: '#B7975B22', borderWidth: 1, borderColor: '#333333' },
  ...
  totalRow:          { flexDirection: 'row', justifyContent: 'space-between', borderTopWidth: 1, borderTopColor: '#333333', marginTop: 10, paddingTop: 10 },
  ...
  btnPagarText:      { color: '#333333', fontWeight: 'bold', fontSize: 12 },
  ...
  btnAccionText:     { color: '#333333', fontSize: 12 },
