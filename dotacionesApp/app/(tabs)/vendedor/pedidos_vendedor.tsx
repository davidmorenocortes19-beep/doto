...
type FiltroEstado = 'Todos' | 'Pendiente' | 'Enviado' | 'Entregado' | 'Cancelado';
const ESTADOS: FiltroEstado[] = ['Todos', 'Pendiente', 'Enviado', 'Entregado', 'Cancelado'];
      ...
      <View style={styles.container}>
        ...
        {cargando && pedidos.length === 0 ? (
          ...
          <FlatList
            ...
            ListEmptyComponent={<Text style={styles.empty}>No hay pedidos</Text>}
          />
        )}
      </View>
                  ...
                  <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.seccion}>
                      ...
                      <View style={styles.totalRow}>
                        ...
                        <Text style={styles.totalValorModal}>${Number(pedidoActivo.total).toLocaleString('es-CO')}</Text>
                      </View>
                    </View>
