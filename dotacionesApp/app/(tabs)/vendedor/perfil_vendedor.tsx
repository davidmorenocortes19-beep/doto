          ...
          <ScrollView contentContainerStyle={styles.scroll}>
            ...
            <View style={styles.seccion}>
              ...
              {[
                ...
                { label: 'Tel�fono',  valor: vendedor?.telefono },
                { label: 'Direcci�n', valor: vendedor?.direccion },
              ].map(item => (
