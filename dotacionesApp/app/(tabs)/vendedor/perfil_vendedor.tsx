...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    borderBottomWidth: 1.5, borderBottomColor: '#166534',
  },
  btnVolver: {
  ...
  // Botones
  btnGuardar: {
    backgroundColor: '#166534', padding: 13,
  ...
  btnSalirText: { color: '#166534', fontWeight: '600', fontSize: 14 },

  // Bottom nav
  bottomNav: {
    flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 8,
    backgroundColor: 'rgba(255, 255, 255, 1.0)',
    borderTopWidth: 1.5, borderTopColor: '#166534',
  },
