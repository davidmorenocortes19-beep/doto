...
const ROL_COLOR  = '#166534';
const ROL_LIGHT  = '#DCFCE7';
const ROL_ICONO  = '💼';
const ROL_NOMBRE = 'Vendedor';
const ROL_DESC   = 'Gestiona ventas y pedidos';
        ...
        <View style={styles.header}>
          ...
          <View style={[styles.accesoBar, { backgroundColor: ROL_LIGHT, borderColor: ROL_COLOR }]}>
            <Text style={[styles.accesoTexto, { color: ROL_COLOR }]}>
              💳 Nivel de acceso: <Text style={{ fontWeight: '700' }}>Comercial</Text>
            </Text>
          </View>
        </View>
