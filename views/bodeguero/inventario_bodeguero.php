  ...
  <style>
    * {
    ...
    background-image: linear-gradient(
        rgba(0, 0, 0, 0.842),
        rgba(0, 0, 0, 0.842)),
        url(../../assets/imagenes/bodegon.avif);
...
<body onload="initializeApp()">
  ...
  <div class="app-container">
    <nav class="sidebar">
      ...
      <ul class="nav-menu">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index_bodeguero.php">Inicio</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="perfil_bodeguero.php">Perfil</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="inventario_bodeguero.php">Inventario</a>
        </li>
      </ul>
    </nav>
  ...
  <script>
    ...
    fetch("https://script.google.com/macros/s/AKfycbxXcNkjfFqASVBjYyJ3Jg5QQEBz1fqt0mxCelL0GbGH3omPp7Er87aFBOrLVbnWM3iN/exec")
  .then(res => res.json())
  .then(data => {
    console.log(data);
  });
  ...
  <script>
fetch("https://script.google.com/macros/s/AKfycbx1_3z8sJQRdzds75MNWgAyRfNbCh3LoqzXJOCmTOlPn1pnlAp03anPqh1GDgG6NVrv/exec")
  .then(res => res.json())
  .then(data => {
    console.log("DATOS:", data);

    let tabla = "<table border='1' style='color:white'>";
